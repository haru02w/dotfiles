{
  ...
  cfg = config.modules.presets.desktop-v1.swaylock;
in {
  options.modules.presets.desktop-v1.swaylock = {
    ...
    services.swayidle = {
      ...
      timeouts = [
        ...
        }
        {
          ...
          resumeCommand = "${getExe' config.wayland.windowManager.hyprland.package "hyprctl"} dispatch dpms on";
        }
      ];
    };
  };
